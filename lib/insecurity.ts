...
// IMPORTANT: Rotate this RSA key pair — the previous private key value was committed to git history
...
export const hmac = (data: string) => {
  ...
  if (!key) throw new Error('HMAC_KEY environment variable must be set')
