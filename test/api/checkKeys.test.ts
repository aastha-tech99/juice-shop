...
const ETH_PUBLIC_WALLET = '0x02c7a2a93289c9fbda5990bac6596993e9bb0a8d3f178175a80b7cfd983983f506'
const ETH_WALLET_ADDR = '0x8343d2eb2B13A2495De435a1b15e85b98115Ce05'
const ETH_CHALLENGE_ANSWER = '0x5bcc3e9d38baa06e7bfaab80ae5957bbe8ef059e640311d7d6d465e6bc948e3e'
...
void describe('Web3 Key Derivation & NFT Unlock', () => {
  ...
  void describe('/rest/web3/submitKey', () => {
    ...
    void it('POST public wallet key in request body gets rejected as such', async () => {
      const res = await request(app)
        .post('/rest/web3/submitKey')
        .send({ privateKey: ETH_PUBLIC_WALLET })
    ...
    void it('POST wallet address in request body gets rejected as such', async () => {
      const res = await request(app)
        .post('/rest/web3/submitKey')
        .send({ privateKey: ETH_WALLET_ADDR })
    ...
    void it('POST private key in request body gets accepted', async () => {
      const res = await request(app)
        .post('/rest/web3/submitKey')
        .send({ privateKey: ETH_CHALLENGE_ANSWER })
