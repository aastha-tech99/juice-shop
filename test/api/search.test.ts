...
void describe('/rest/products/search', () => {
  ...
  void it('GET product search with SQL special characters returns no results due to parameterized query', async () => {
    const res = await request(app)
  ...
  void it('GET product search SQL Injection with two missing closing parenthesis is prevented by parameterized query', async () => {
    const res = await request(app)
  ...
  void it('GET product search SQL Injection with one missing closing parenthesis is prevented by parameterized query', async () => {
    const res = await request(app)
      .get("/rest/products/search?q=') union select id,email,password from users--")
    assert.equal(res.status, 200)
    assert.ok(res.headers['content-type']?.includes('application/json'))
  ...
  void it('GET product search UNION SELECT injection is prevented by parameterized query', async () => {
    const res = await request(app)
  ...
  void it('GET product search UNION SELECT with fixed columns is prevented by parameterized query', async () => {
    const res = await request(app)
  ...
  void it('GET product search UNION SELECT with Users table columns is prevented by parameterized query', async () => {
    const res = await request(app)
  ...
  void it('GET product search UNION SELECT with sqlite_master is prevented by parameterized query', async () => {
    const res = await request(app)
  ...
  void it('GET product search where-clause termination injection is prevented by parameterized query', async () => {
    const res = await request(app)
      .get("/rest/products/search?q=seasonal%20special%20offer'))--")
    assert.equal(res.status, 200)
    assert.ok(res.headers['content-type']?.includes('application/json'))
  ...
  void it('GET product search cannot select logically deleted christmas special via SQL injection due to parameterized query', async () => {
    const res = await request(app)
  ...
  void it('GET product search cannot select logically deleted unsafe product via SQL injection due to parameterized query', async () => {
    const res = await request(app)
