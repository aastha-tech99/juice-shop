...
void describe('/rest/products/search', () => {
  ...
  void it('GET product search with SQL Injection attempt is safely handled', async () => {
    const res = await request(app)
  ...
  void it('GET product search SQL Injection with UNION SELECT is prevented', async () => {
    const res = await request(app)
  ...
  void it('GET product search SQL Injection with closing parenthesis is prevented', async () => {
    const res = await request(app)
      .get("/rest/products/search?q=') union select id,email,password from users--")
    assert.equal(res.status, 200)
    assert.ok(res.headers['content-type']?.includes('application/json'))
  ...
  void it('GET product search SQL Injection with SELECT * FROM attack is prevented', async () => {
    const res = await request(app)
  ...
  void it('GET product search UNION SELECT with Users table and fixed columns is prevented', async () => {
    const res = await request(app)
  ...
  void it('GET product search UNION SELECT with Users table and required columns is prevented', async () => {
    const res = await request(app)
  ...
  void it('GET product search UNION SELECT with sqlite_master table is prevented', async () => {
    const res = await request(app)
  ...
  void it('GET product search SQL injection to select logically deleted christmas special is prevented', async () => {
    const res = await request(app)
  ...
  void it('GET product search SQL injection to select logically deleted unsafe product is prevented', async () => {
    const res = await request(app)
