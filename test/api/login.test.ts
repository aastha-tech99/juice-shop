...
void describe('/rest/user/login', () => {
  ...
  void it('POST login with WHERE-clause disabling SQL injection attack is prevented by parameterized query', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST login with known email "admin@juice-sh.op" in SQL injection attack is prevented by parameterized query', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST login with known email "jim@juice-sh.op" in SQL injection attack is prevented by parameterized query', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST login with known email "bender@juice-sh.op" in SQL injection attack is prevented by parameterized query', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST login with UNION SELECT injection attack is prevented by parameterized query', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST login with query-breaking SQL Injection attack is prevented by parameterized query', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
