...
void describe('/rest/user/login', () => {
  ...
  void it('POST login with WHERE-clause disabling SQL injection attack is prevented', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST login with known email "admin@juice-sh.op" in SQL injection attack is prevented', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST login with known email "jim@juice-sh.op" in SQL injection attack is prevented', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST login with known email "bender@juice-sh.op" in SQL injection attack is prevented', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST login with non-existing email "acc0unt4nt@juice-sh.op" via UNION SELECT injection attack is prevented', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
