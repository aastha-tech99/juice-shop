...
void describe('/rest/user/login', () => {
  ...
  void it('POST login with known email in SQL injection attack is prevented by parameterized query', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST login with jim email in SQL injection attack is prevented by parameterized query', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST login with bender email in SQL injection attack is prevented by parameterized query', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
