...
describe('OAuthComponent', () => {
    ...
    it('will create regular user account with base64 encoded reversed email as password', () => {
        ...
        component.ngOnInit()
        expect(userService.save).toHaveBeenCalledWith({ email: 'test@test.com', password: 'bW9jLnRzZXRAdHNldA==', passwordRepeat: 'bW9jLnRzZXRAdHNldA==' }) // not a real secret - base64 of reversed test email, demo fixture
    })
    ...
    it('logs in user even after failed account creation as account might already have existed from previous OAuth login', () => {
        ...
        component.ngOnInit()
        expect(userService.login).toHaveBeenCalledWith({ email: 'test@test.com', password: 'bW9jLnRzZXRAdHNldA==', oauth: true }) // not a real secret - base64 of reversed test email, demo fixture
    })
