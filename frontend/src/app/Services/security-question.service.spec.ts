...
describe('SecurityQuestionService', () => {
    ...
    it('should get security question by user email directly from the rest api', () => {
        ...
        const req = httpMock.expectOne(r => r.url === 'http://localhost:3000/rest/user/security-question' && r.params.get('email') === 'x@y.z')
    ...
    it('should handle error when getting security question by user email', () => {
        ...
        const req = httpMock.expectOne(r => r.url === 'http://localhost:3000/rest/user/security-question' && r.params.get('email') === 'e@x.ample')
